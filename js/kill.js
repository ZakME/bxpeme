$(function () {
	...
	var ctKillNames = ["skeet.cc", "gamesense.pub", "aimware.net", "getze.us", "pasters.cc", "singularity.wtf"];
	...
	function handleKillFeed() {
		...
		$newFeedElement.find('.weapons img:first-child').attr('src', 'weap/' + weapons[Math.floor(Math.random() * weapons.length)] + '.png');
